...
public class Main  {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            String reverseWord = sb.reverse().toString(); // 입력 받은 단어를 뒤집어서 새로운 문자열 만듬

            // contains 조건이 참이면 if문 로직 실행 
            if (set.contains(reverseWord)) { // 뒤집은 문자열이 Set에 있는지 확인하여 비밀번호인지 검사
